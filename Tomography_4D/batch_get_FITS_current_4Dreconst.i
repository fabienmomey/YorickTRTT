...
Htomo_reconst_name="./preliminary_results_from_kubilai/CLBpatient_SD_120x120x72x13_voxel_8mm_detector_8mm.rec";
...
nt=13;
for (i=1;i<=nt;++i){
    fits_write, swrite(format="%sx_detec8mm%02d.fits",datadir,i), x_iter(:,:,:,i), overwrite=1n;
}
